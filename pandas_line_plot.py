...
plt.plot(mydata['date'][mydata['city']=='birmingham'], mydata['temp_high_avg'][mydata['city']=='birmingham'], 'grey')
plt.plot(mydata['date'][mydata['city']=='cleveland'], mydata['temp_high_avg'][mydata['city']=='cleveland'], 'black')
#Add a moving average
plt.plot(mydata['date'][mydata['city']=='birmingham'], mydata['temp_high_avg'][mydata['city']=='birmingham'].rolling(5).mean(), 'b--')
plt.plot(mydata['date'][mydata['city']=='cleveland'], mydata['temp_high_avg'][mydata['city']=='cleveland'].rolling(5).mean(), 'r--')
plt.title('Temperature')
plt.xlabel('Date')
plt.ylabel('Temperature (F)')
plt.legend(['Birmingham', 'Cleveland','Birmingham Move Avg', 'Cleveland Move Avg'])
plt.show()
